...
class CartefideliteController extends AbstractController
{
     ...
     */
    public function statistiques(CartefideliteRepository $cartefideliteRepository): Response
    {
        ...
        foreach($cartes as $carte){
            $dateexpiration[] = $carte->getDateexpiration()->format('d-m-Y');
            $nbpts[] = $carte->getNbpts() ;
            
        }


        return $this->render('cartefidelite/stats.html.twig', [
            'dateexpiration' => json_encode($dateexpiration),
