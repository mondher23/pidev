...
if (file_exists(realpath(_DIR_ . "/../../lib/res/broken_image.svg"))) {
    Cache::$broken_image = realpath(_DIR_ . "/../../lib/res/broken_image.svg");
}